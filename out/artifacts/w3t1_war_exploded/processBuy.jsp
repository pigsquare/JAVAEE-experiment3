...
<%
    ...
    try{
        ...
        if(conn != null && buys.length>0 && userId!=null){
            //out.print("Connection Success.<br/>");
            for(int i=0; i<buys.length; i++){
                Statement stmt = null;
                String sql = "INSERT INTO shop_records (number,shopDate,userId, productId) VALUES (1,' "
                        + d.toLocalDate().toString() + "','" + userId + "','" +buys[i] +"');";
                stmt = conn.createStatement();
                stmt.execute(sql);
            }
            out.println("购买成功！<br>7日之内购买历史记录<br>" +
